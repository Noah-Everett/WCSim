...
// Phase 3 is ANNIE + Argon
// This function is a slightly modified version of SetANNIEPhase2Geometryv7()
void WCSimDetectorConstruction::SetANNIEPhase3Geometryv0()
{
  WriteGDMLFile     = false;
  ...
  isANNIE=true;
  WCDetectorName = "ANNIEp3v0";
  G4String WCDetectorName_imitation="ANNIEp2v7";
  
  // tank PMT collections - one for each type of PMT.
  WCIDCollectionName="WCIDCollectionNameIsUnused";  // some default.
  // the order in the maps is important due to hardcoded hacking in ConstructCylinder
  std::string WCIDCollectionName_R7081 = WCDetectorName_imitation +"-glassFaceWCPMT_R7081";
  std::string WCIDCollectionName_D784KFLB = WCDetectorName_imitation +"-glassFaceWCPMT_D784KFLB";
  std::string WCIDCollectionName_R5912HQE = WCDetectorName_imitation +"-glassFaceWCPMT_R5912HQE";
  std::string WCIDCollectionName_R7081HQE = WCDetectorName_imitation +"-glassFaceWCPMT_R7081HQE";
  WCTankCollectionNames.push_back(WCIDCollectionName_R7081);     // 10" LUX/Watchboy
  WCTankCollectionNames.push_back(WCIDCollectionName_D784KFLB);  // 11" HQE LBNE
  WCTankCollectionNames.push_back(WCIDCollectionName_R5912HQE);  //  8" HQE new
  WCTankCollectionNames.push_back(WCIDCollectionName_R7081HQE);  // 10" HQE Watchman
  ...
  // other detector element collections
  WCMRDCollectionName = WCDetectorName_imitation +"-glassFaceWCPMT_MRD";
  WCFACCCollectionName = WCDetectorName_imitation +"-glassFaceWCPMT_FACC";
  WCIDCollectionName2 = WCDetectorName_imitation +"-glassFaceWCONLYLAPPDS";
